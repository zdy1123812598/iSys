			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="linkEdit.htm"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="linkname" name="linkname" value ="${linkname}" />
							</div>
						</div>						
						<div class="control-group">
							<label class="control-label"> 上级目录 </label>
							<div class="controls">
								<select id="parentid" name="parentid" style="width: 50%" autocomplete="off">
