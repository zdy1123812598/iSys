				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="#"
							name="roleForm" id="roleForm" novalidate="novalidate" />
							<table class="table">
							<tr ><td colspan="2">
							<label class="control-label" style="margin:10px;">角色名称</label>
							<div class="controls">
								<input type="text" style="height:30px;"  name="rolename" id="rolename"
									placeholder="请输入角色名称" />
							</td></tr>
							<tr><td>
						...
						<!-- <div class="control-group" style="margin: 50px;">
							<label class="control-label" style="margin:10px;">角色名称</label>
							<div class="controls">
								<input type="text" style="height:30px;"  name="rolename" id="rolename"
									placeholder="请输入角色名称" />
							 ...
							 <label class="control-label" style="margin:10px;">人员选择</label>
								<div id="treeview-checkable" class="controls"  style="margin: 0 220px ;width:30%;"></div>
								<label class="control-label" style="margin:10px;">权限列表</label>
								<div id="treeview-checkable1" class="controls" style="margin: 0 220px;width:30%;"></div>
						</div>
						<div align="center" class="control-group">
							<input type="submit" value="确定" class="btn btn-primary"
								id="btnAdd" /> <input type="reset" value="重置"
	...
	<script type="text/javascript">
		...
		$.ajax({
			...
			$.ajax({
				...
				data : {roleid : 0,creatorid : $('#unid', window.parent.document).val()},
